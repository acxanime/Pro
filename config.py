...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7707522221:AAGnoRkH4XuqXKFk81ScGdPDUCt5RYaLIsw") 
   
    # database config
    DATABASE_NAME = os.environ.get("DATABASE_NAME","Cluster0")     
    DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Kdramast:Kdramast@cluster0.uhf52.mongodb.net/?retryWrites=true&w=majority")
    ...
    AUTH_CHANNELS = list(map(int, os.environ.get("AUTH_CHANNELS","ST_Rename_Update").split())) # Add Multiple Channels iD By Space
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002320080278"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002451946366"))
...
<blockquote><b>𝘕𝘰𝘵𝘦 :</b> 𝘈𝘥𝘶𝘭𝘵 𝘊𝘰𝘯𝘵𝘦𝘯𝘵 𝘪𝘴 𝘚𝘛𝘙𝘐𝘊𝘛𝘓𝘠 𝘱𝘳𝘰𝘩𝘪𝘣𝘪𝘵𝘦𝘥 𝘉𝘢𝘯 𝘸𝘪𝘭𝘭 𝘣𝘦 𝘱𝘦𝘳𝘮𝘢𝘯𝘦𝘯𝘵.</blockquote>"""
    ...
    ABOUT_TXT = ABOUT_TXT = """<b>‣ ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/FileRenamerSTbot'>ʀᴇɴᴀᴍᴇ ʙᴏᴛ</a>
‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
‣ ᴅᴀᴛᴀʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏᴅʙ</a>
‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 𝟹</a> 
‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://www.koyeb.com/'>ᴋᴏʏᴇʙ</a>
‣ ᴄʀᴇᴀᴛᴇᴅ ʙʏ : <a href='https://telegram.me/Sitaratoons_Support_bot'>TS Rename</a></b>"""
